...
<body style="background-color : rgb(234, 245,250);">
<?php
    include 'data.php';
...
<footer class="footer_distributed">
        <div class="footer_left">
            ...
            <p class="footer_company_name">SPARK Bank &copy;Copyright 2021 </p>
            <p class="footer_company_name">
            Made By : SYED MISHAL</p>
            <p class="footer_company_name">
             #GRIPFJULY2021 Web Development & Designing Internship </p>
        </div>
        <div class="footer_center">
            ...
            <div>
                ...
                <p><span>+91-984852642</span> </p>
            </div>
            <div>
                <i class="fa fa-envelope"></i>
                <p><a href="#">contact@sparkbank.com</a></p>
            </div>
            </div>
            <div class="footer_right">
                <p class="footer_company_about">
                 <span>About Us</span>
                 This is a website used for transferring money online .
